...
<head>
    ...
    <title>@yield('title', 'Admin — Go.Canteen')</title>
    ...
    <aside id="sidebar" class="w-64 bg-white border-r border-gray-100 fixed top-0 left-0 bottom-0 flex flex-col z-50 transform -translate-x-full md:translate-x-0">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            @foreach([
                ...
                ['admin/penjual',   '🧑‍🍳', 'Penjual'],
                ['admin/stand',     '🏪', 'Kelola Stand'],
        ...
        <div class="p-4 border-t border-gray-100">
            <div class="flex items-center gap-3 bg-gray-50 rounded-xl p-3">
                <div class="w-8 h-8 bg-green-700 rounded-lg flex items-center justify-center font-bold text-white text-sm">
