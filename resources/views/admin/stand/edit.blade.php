    ...
    <form action="/admin/stand/{{ $stand->id }}" method="POST" autocomplete="off">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="hidden" name="emoji" id="emojiInput" value="{{ old('emoji', $stand->emoji) }}"/>
                <div class="relative">
                    <button type="button" onclick="toggleEmojiPicker()"
                        ...
                        <span id="emojiPreview" class="text-2xl">{{ old('emoji', $stand->emoji) }}</span>
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama', $stand->nama) }}"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="2"
                          class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-green-500 focus:outline-none resize-none">{{ old('deskripsi', $stand->deskripsi) }}</textarea>
            </div>
            <div class="flex items-center gap-3">
                <input type="checkbox" name="aktif" id="aktif" {{ $stand->aktif ? 'checked' : '' }} class="w-4 h-4 accent-green-700"/>
